...
/// </summary>
public class PatientMergedEventLoggingHandler(ILogger<PatientMergedEventLoggingHandler> logger)
    : INotificationHandler<PatientMergedEvent>
{
    public Task Handle(PatientMergedEvent notification, CancellationToken cancellationToken)
    {
        logger.LogInformation(
            "Patient merge completed: Primary {PrimaryPatientId}, Merged {MergedPatientId}, MergedAt {MergedAt}, MergedByUserId {MergedByUserId}",
