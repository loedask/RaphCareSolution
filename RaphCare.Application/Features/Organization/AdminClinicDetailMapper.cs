...
internal static class AdminClinicDetailMapper
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new ClinicDetailDto
        {
            ...
            CommercialPlan = ClinicCommercialPlan.Normalize(clinic.CommercialPlan),
            HasInpatient = ClinicCommercialPlanFeatures.HasInpatient(clinic.CommercialPlan),
            HasCollection = ClinicCommercialPlanFeatures.HasCollection(clinic.CommercialPlan),
            HasCasualty = ClinicCommercialPlanFeatures.HasCasualty(clinic.CommercialPlan),
            HasTheatre = ClinicCommercialPlanFeatures.HasTheatre(clinic.CommercialPlan),
            HasConsultWaiting = ClinicCommercialPlanFeatures.HasConsultWaiting(clinic.CommercialPlan),
