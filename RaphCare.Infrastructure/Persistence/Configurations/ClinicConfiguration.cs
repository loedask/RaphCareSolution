...
public class ClinicConfiguration : IEntityTypeConfiguration<Clinic>
{
    public void Configure(EntityTypeBuilder<Clinic> builder)
    {
        ...
        builder.Property(e => e.CommercialPlan)
            .IsRequired()
            .HasMaxLength(ClinicCommercialPlan.MaxLength)
            .HasDefaultValue(ClinicCommercialPlan.Default);
        ...
        builder.Property(e => e.ConsultDisplayToken).HasMaxLength(ClinicCollectionDisplayToken.Length);
        ...
        builder.HasIndex(e => e.ConsultDisplayToken)
            .IsUnique()
