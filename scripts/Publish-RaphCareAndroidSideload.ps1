...
Write-Host "  docs/mobile-updates/sources/mobile-update-v$($version.DisplayVersion)+$($version.VersionCode).md"
Write-Host "  scripts/Export-RaphCareMobileUpdatePdf.ps1 -Version $($version.DisplayVersion)+$($version.VersionCode)"
Write-Host "PDF output: docs/mobile-updates/mobile-update-v$($version.DisplayVersion)+$($version.VersionCode).pdf"
Write-Host "Archive the previous PDF under docs/mobile-updates/archives/ and its .md/.config under sources/archives/."
