...
public abstract class BaseHttpService(IClient client, HttpClient httpClient)
{
    ...
    /// <summary>PUT without a body; treats 204 as success.</summary>
    protected async Task<Response<bool>> PutEmptyAsync(string requestUri, CancellationToken cancellationToken = default)
    {
        try
        {
