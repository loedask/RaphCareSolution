...
/// </summary>
public class PersistenceUnitOfWork(
    IdentityDbContext identity,
    ClinicalDbContext clinical,
    DeviceDbContext device,
    InsuranceDbContext insurance,
    BillingDbContext billing,
    AIDbContext ai) : IUnitOfWork
{
    private readonly IdentityDbContext _identity = identity ?? throw new ArgumentNullException(nameof(identity));
    ...
    private readonly AIDbContext _ai = ai ?? throw new ArgumentNullException(nameof(ai));
