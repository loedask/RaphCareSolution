...
<p class="subtitle">Portal, ops, and the patient phone app · September 2026</p>
</div>
</div>

This is the shareable list of what RaphCare does. It is grouped the way we talk about the product: **portal** (the website), **ops** (staff work inside a hospital or clinic), and **mobile** (the patient phone app).
...
<div class="note">
<p><strong>How to sell vs what you can demo.</strong> Staging shows the full hospital workspace so a walkthrough is easy. Commercially, Clinic is the lighter outpatient set. Hospital adds beds, the counter, casualty, theatre, and the rest of the stay. The headings below follow that split.</p>
</div>
...
## 1. Portal (the website)

The site people open in a browser: landing, sign-in, and screens that do not need a staff login (waiting TVs). After staff sign in, they land in ops. After a patient signs in on the web, they get a short welcome. The full patient product is the phone app.

| Feature | What it does | Status |
|---------|--------------|--------|
| Public landing | Choose patient or healthcare professional, then sign in or create an account. | Ready |
| Professional sign-in | Staff sign in and reach the clinic workspace. | Ready |
...
| Staff use on a phone | Same website on a small screen. Needs layout work first. Not a separate staff app. | Later |

---

## 2. Ops (staff work after you open a site)

This is the clinic and hospital workspace in the browser. Opening a site hides the left menu so the tools have more room. All hospitals, language, and sign out stay in the top bar.
...
| Home and navigation | Home dashboard and the main areas of the app. | Ready |
| Choose my clinic | Search by clinic name or enter a short clinic code from the hospital. | Ready |
| Settings and profile | Personal info, medical info, emergency contacts, privacy, help, language, and change password. Patients can add a photo. | Ready |
...
| Mental health | Mood check-in and related content. | Ready |
...
| E580 or E585 style band | Scan and connect. Heart rate and oxygen when the band speaks those readings. Confirm on your sample watches. | In progress |
...
| Feature | What it does | Status |
|---------|--------------|--------|
| Staging demo clinic | Fake staff and a patient on staging so you can walk the screens. Does not wipe other hospitals. | Ready |
...
Patients use the phone app. Staff use the website. There is no clinician phone app in this catalog.
