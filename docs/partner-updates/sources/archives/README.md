...
Markdown and PDF config for older dated partner notes and prior catalog, price list, and demo-accounts versions. Matching PDFs live in `docs/partner-updates/archives/`.
