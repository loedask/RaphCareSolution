...
**Premium soft design lock and patient screen map:** **[`../../Mobile_Concept_Port.md`](../../Mobile_Concept_Port.md)**. Use this doc for **product completeness**, **rollout**, and **quality bar** before calling the patient app "ready."
...
| Visual polish (Premium soft) | | See **[`../../Mobile_Concept_Port.md`](../../Mobile_Concept_Port.md)**. |
...
**`appsettings.Development.json`** is set so **every flag is `true`** for DEBUG builds (local work). **`appsettings.json`** (tracked defaults) keeps most verticals off until you choose prod/pilot rollout.
...
Use the patient screen map in **[`../../Mobile_Concept_Port.md`](../../Mobile_Concept_Port.md)** as the spine. Extend with **list / book / detail / add** rows per vertical as you lock each flow.
...
- **Dark mode:** second resource dictionary vs explicit **not in v1** decision (**[`../../Mobile_Concept_Port.md`](../../Mobile_Concept_Port.md)**).
