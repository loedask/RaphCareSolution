...
| Live heart rate and blood oxygen in the app | Partial | Android vendor Measure is on only in engineer probe 1.8.48 (vendor-only scan). Confirm later when Connect stays open |
