...
| Connect **E580** or **E585** style Bluetooth bands | Partial | Scan and Connect keep the link when you leave Devices. Open Watch readings, then Measure now for heart rate and oxygen (on-watch Health Monitor alone does not fill the phone). Measure retries when the watch radio is still busy after Connect. Blood pressure and other monitors are later |
