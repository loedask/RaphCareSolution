...
- **Client:** Contracts (Response, ApiException), Contracts/Interfaces (IPatientService), Services/Base (IClient, Client, BaseHttpService), Services/Base/Generated (NSwag ClientService), Services, Models, Mappings; one ServiceRegistration for registration.
