...
/// <summary>Public waiting-room boards. Codes only. Does not require X-Clinic-Id or sign-in.</summary>
[AllowAnonymous]
[ApiController]
[Route("api/display")]
public sealed class CollectionDisplayController(IMediator mediator) : ControllerBase
{
    ...
    [HttpGet("casualty/{token}", Name = "GetCasualtyDisplay")]
    [ProducesResponseType(typeof(CasualtyDisplayBoardDto), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
